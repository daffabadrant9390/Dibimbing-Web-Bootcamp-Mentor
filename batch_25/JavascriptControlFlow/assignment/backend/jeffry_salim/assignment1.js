...
for (let i = 1; i <= 20; i++) {
    ...
    //pertama dengan kondisi bilangan ganjil dan bilangan genap
    if (i % 2 != 0) {
    ...
    //kedua dengan kondisi habis dibagi 4, habis dibagi 6, habis dibagi 4 dan 6, habis dibagi 3 atau 5
    if ((i % 4 == 0) && (i % 6 == 0)) {
