...
Ekspektasi Output:
Output mencerminkan pemahaman terhadap conditional dan looping.
Format output sesuai instruksi.
Tidak ada hardcode hasil, student diharapkan memahami logika dan implementasi program.
...
for (let nilai = 1; nilai <= 5; nilai++) {
    for (let pangkat = 1; pangkat <= 3; pangkat++) {
        ...
        console.log(`${nilai} dipangkat ${pangkat} = ${hasil}`)
    }
