...
for(let bilangan = 1; bilangan<=20; bilangan++ ) {
 ...
 else console.log(`${bilangan} merupakan bilangan Genap`);
 if(bilangan%4 === 0 && bilangan%6 === 0) 
        console.log(`${bilangan} habis dibagi dengan angka 4 dan 6`) 
    else if (bilangan % 4 === 0)  console.log(`${bilangan} habis dibagi 4`) 
        else if(bilangan % 6 === 0) console.log(`${bilangan} habis dibagi 6`)
            else if(bilangan % 3 === 0 || bilangan % 5 === 0) console.log(`${bilangan} habis dibagi 3 atau 5`)
                else console.log(`${bilangan}`);
