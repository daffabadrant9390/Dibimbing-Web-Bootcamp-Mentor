...
const isCumlaude = (semesterSiswa >= 5 && semesterSiswa <= 7) && (ipkSiswa > 3.75) && (rataRataNilai > 90);

// 3. Menentukan kondisi lulus biasa
const isLulusBiasa = (semesterSiswa >= 5 && semesterSiswa <= 10) && (ipkSiswa > 2.75) && (rataRataNilai > 85);
