...
for (let i = 1; i <=rangeAngka; i++) {
    if (i % 4 === 0 && i %6 ===0 ){
        console.log("Angka", i , "habis dibagi 4 dan 6");
    }else if (i % 4 === 0 ){
        console.log("Angka", i , "habis dibagi 4");
    }else if (i % 6 === 0 ){
        console.log("Angka", i , "habis dibagi 6");
    }else if (i % 3 === 0 || i % 5 === 0){
        console.log("Angka", i , "habis dibagi 3 atau 5");
    } else if(i % 2 === 0){
        console.log("Angka" , i ,"merupakan bilangan Genap");
    }else if (i % 2 !== 0) {
        console.log("Angka", i, "merupakan bilangan Ganjil");  
    }else{
        console.log(i);
    }
}
...
// while (counter <= rangeAngka){
//     if (counter % 4 === 0 && counter % 6 ===0 ){
//         console.log("Angka", counter,"habis dibagi 4 dan 6");
//         }else if (counter % 4 === 0 ){
//             console.log("Angka", counter, "habis dibagi 4");
//         }else if (counter % 6 === 0 ){
//             console.log("Angka", counter, "habis dibagi 6");
//         }else if (counter % 3 === 0 || counter % 5 === 0){
//             console.log("Angka", counter, "habis dibagi 3 atau 5"); 
//         }else{
//             console.log(counter);
//         }  
// }
